...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'nogaentreprenad-leads' ),
				'storm'       => __( 'Storm or hail damage', 'nogaentreprenad-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'nogaentreprenad-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'nogaentreprenad-leads' ),
				'not-sure'    => __( 'Vet inte än', 'nogaentreprenad-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'nogaentreprenad-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'nogaentreprenad-leads' ),
				'research' => __( 'Jag kollar bara priser', 'nogaentreprenad-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'nogaentreprenad-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'nogaentreprenad-leads' ),
		'contacted' => __( 'Kontaktad', 'nogaentreprenad-leads' ),
		'quoted'    => __( 'Quote sent', 'nogaentreprenad-leads' ),
		'won'       => __( 'Won', 'nogaentreprenad-leads' ),
		'lost'      => __( 'Lost', 'nogaentreprenad-leads' ),
		'spam'      => __( 'Misstänkt spam', 'nogaentreprenad-leads' ),
	);
}
