<?php
/**
 * Noga Entreprenad AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Noga Entreprenad AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'nogaentreprenad', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'nogaentreprenad' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'nogaentreprenad' ) ) );

		register_block_pattern_category( 'nogaentreprenad-sections', array( 'label' => __( 'Noga Entreprenad AB sections', 'nogaentreprenad' ) ) );
		register_block_pattern_category( 'nogaentreprenad-pages', array( 'label' => __( 'Noga Entreprenad AB page layouts', 'nogaentreprenad' ) ) );
	}
);
