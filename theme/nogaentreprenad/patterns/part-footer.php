...
/**
 * Title: Part: sidfot
 * Slug: nogaentreprenad/part-footer
 * Inserter: no
 *
...
<p class="has-text-align-center no-footer-note has-small-font-size" style="margin-top:var(--wp--preset--spacing--50)">Noga Entreprenad AB AB · Demosajt byggd som förslag. Bilder och omdömen är platshållare.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
